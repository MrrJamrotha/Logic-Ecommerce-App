    ...
    return DefaultTabController(
      ...
      child: NestedScrollView(
        ...
        body: TabBarView(
          ...
          controller: _tabContoller,
          children: [
            NewProductTab(merchantId: widget.parameters['merchant_id']),
            TopSaleTab(merchantId: widget.parameters['merchant_id']),
            PromotionProductTab(merchantId: widget.parameters['merchant_id']),
            BastMatchTab(merchantId: widget.parameters['merchant_id']),
          ],
        ),
      ),
    );
